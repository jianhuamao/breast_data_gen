...
# 读取label文件
excel_file = r'E:\标注的数据都在此-本院-外院\label-建模1293clinical data.xlsx'

# 指定保存路径的文件夹
b0_output_folder = r'F:\BreastMR-Data\old-preprocess\classification-new\b0'
b800_output_folder = r'F:\BreastMR-Data\old-preprocess\classification-new\b800'
t2_output_folder = r'F:\BreastMR-Data\old-preprocess\classification-new\t2'
c_output_folder = r'F:\BreastMR-Data\old-preprocess\classification-new\c'
segment_ouput_folder = r'F:\BreastMR-Data\old-preprocess\classification-new\segment'


# 保存标签的文件
csv_file = r'F:\BreastMR-Data\old-preprocess\classification-new\label.csv'
...
def main():
    for data in os.listdir(origin_dir):
        ...
        # 该路径下最小的文件为增强图像的Mask
        origin_segment_dir =find_least_file(CImageDir)['name']
